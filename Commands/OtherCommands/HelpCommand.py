...
class HelpCommand(ICommand):
    def execute_command(self, command):
        if cmd.casefold() == command.casefold():
            print(cmd + ", " + StopCommand.get_command_name() + ", " + AddOrder.get_command_name() + ", " + AddCourierCommand.get_command_name() +
                  ", " + CourierStatsCommand.get_command_name() + ", " + GetOrderInfo.get_command_name() + ", " + StartProgram.get_command_name())
            return
